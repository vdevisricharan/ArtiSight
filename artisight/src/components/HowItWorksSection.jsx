        ...
        <div className="container mx-auto px-8 py-20" id='how-it-works'>
            ...
            <div className="flex flex-col sm:flex-row gap-8 items-center justify-start">
                <div className="w-full sm:w-1/3 text-left py-4">
                    <img src=".assets/14_pretty-yellow-bird.jpg" alt="Step 1" className="mx-auto rounded-2xl bg-contain" />
                ...
                <div className="w-full sm:w-1/3 text-left py-4">
                    <img src="./assets/14_pretty-yellow-bird.jpg" alt="Step 2" className="mx-auto rounded-2xl" />
                ...
                <div className="w-full sm:w-1/3 text-left py-4">
                    <img src="./assets/14_pretty-yellow-bird.jpg" alt="Step 3" className="mx-auto rounded-2xl" />
